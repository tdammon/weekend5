                        ...
                        <Card className={classes.root}>
                            <CardContent className={classes.cardDisplay}>
                                <form className={classes.formDisplay}>
                                    <InputLabel>How well do you understand today's content</InputLabel>
                                    <Select value={this.state.understand} onChange={this.handleChange}>
...
export default withRouter(connect()(withStyles(styles)(SecondPage)));